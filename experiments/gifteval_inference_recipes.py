...
INFERENCE_RECIPES = {
    ...
    # v3 restores the public wrapper exactly: original attention mask, no_grad,
    # and API-specific input placement (legacy inputs stay on CPU; current
    # past_values move to the model device). This invalidates the score-changing
    # padding-safe-v2 forecasts.
    "patchtst_fm": "official_patchtst_fm_wrapper_v3",
